...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-16 scale-0 group-hover:scale-100 transition-all duration-200 origin-right bg-[#112240] text-[#f3f4f6] text-xs font-semibold py-2 px-3 rounded shadow-md border border-[#d4af37]/30 whitespace-nowrap">
        Chat with us!
      </span>
    </a>
  );
